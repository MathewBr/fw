                ...
                <form action="<?=ADMIN;?>/product/edit" method="post" data-toggle="validator" id="add">
                    <div class="box-body">
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <textarea name="content" id="editor_area" cols="80" rows="10"><?=$product->content;?></textarea>
                        </div>
                        ...
                        <?php new \app\widgets\filters\Filter($filter, APP . '/widgets/filters/admin_filter_tpl.php'); ?>
                        <div class="form-group">
                            <div class="col-md-4">
                                <div class="box box-danger box-solid file-upload">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="single">
                                            ...
                                            <?php //unset($_SESSION['single']); //$_SESSION['single'] = $product->img; ?>
                                        </div>
                                    </div>
                                    <div class="overlay">
                                        ...
                                        <div class="multi">
                                            <?php if(!empty($gallery)): ?>
                                                <?php foreach($gallery as $item): ?>
                                                    ...
                                                    <?php unset($_SESSION['multi']); //$_SESSION['multi'][] = $item; ?>
                                                <?php endforeach; ?>
                                            <?php endif; ?>
                                        </div>
                                    </div>
