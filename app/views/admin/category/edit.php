...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?=ADMIN;?>/category"><i class="fa fa-list"></i>Список Категорий</a></li>
                ...
                <form action="<?=ADMIN;?>/category/edit" method="post" data-toggle="validator">
                    <div class="box-body">
                        <div class="form-group has-feedback">
                            ...
                            <input type="text" name="title" class="form-control" id="title" value="<?=h($category->title)?>" placeholder="Наименование категории" required>
